...
def say_hello_default_arg(name="Dhir"):
...
def multiple_args(name1="Arpita", name2="Dhir", name3="Amit"):
    print("Multiple Arguments are as follow:", name1, name2, name3)


multiple_args(name1="Ram", name2="Yunus", name3="Deepshikha")
multiple_args(name1="Rahul")
...
result1 = sum_of_two_number(num1=34, num2=34)
print(result1)
